...
import math
from agent_ppo.conf.conf import FeatureConfig as FC
from agent_ppo.feature.targeting import (
    BUILDING_ACTOR_TYPE,
    MINION_ACTOR_TYPE,
    MINION_SUBTYPE,
    TOWER_SUBTYPE,
...
class FeatureBuilder:
    ...
    # ---- 主入口 ----
    def build(self, frame_state, retreat_need_active=False):
    ...
    def _global_feature(
        ...
        g.append(1.0 if retreat_need_active else 0.0)
